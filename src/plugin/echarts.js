        ...
        return {
          chinaMap: function (id, data) {
            ...
            var option = {
              tooltip: {
                ...
                enterable: true,
                formatter(data) {
                  return "<a href='/city/" + data.name + "' style:'color:#000'><div><p>" + data.name + "</p></div><div><p>现存确诊:" + data.data.value + "</p></div></a>"
                }
              },
              visualMap: [{//映射-颜色值
                type: 'piecewise',//分段
          ...
          worldMap: function (id, data) {
            ...
            var option = {
              tooltip: {
                formatter(data) {
                  return "<div><p>" + data.name + "</p></div><div><p>现存确诊:" + data.value + "</p></div>"
                }
              },
              visualMap: [{//映射-颜色值
                type: 'piecewise',//分段
                pieces: [
                  ...
                  { min: 1000000, max: 10000000, color: '#4f070d' },
                ]
              }],
              nameMap: {
                "Afghanistan": "阿富汗",
